...
return [
    ...
    */
    ...
    |
    | This app keeps Shield role management in the /system panel only. The
    | tenant /gym panel still uses the generated permissions for authorization,
    | but it must not expose RoleResource because Spatie's Role model does not
    | have the gym() relationship required by the tenant panel.
    |
    */
    ...
    */
    ...
    'resources' => [
        ...
        'exclude' => [
            \App\Filament\Resources\BusinessRoleResource::class,
            \App\Filament\Resources\GymResource::class,
            \App\Filament\Resources\GymSubscriptionResource::class,
            \App\Filament\Resources\SystemAdminResource::class,
            \App\Filament\Resources\SystemPlanResource::class,
            \App\Filament\Resources\SystemRoleResource::class,
    ...
    */
    ...
    'widgets' => [
        ...
        'exclude' => [
            ...
            \App\Filament\Widgets\Analytics\MembershipMetricsWidget::class,
            \App\Filament\Widgets\Analytics\FinancialMetricsWidget::class,
            \App\Filament\Widgets\Analytics\ExpenseCategoriesDoughnutChartWidget::class,
            \App\Filament\Widgets\Analytics\MembershipOverviewSubscriptionsTableWidget::class,
            \App\Filament\Widgets\Analytics\RecentTransactionsTableWidget::class,
            \App\Filament\Widgets\Analytics\CashflowTrendChartWidget::class,
            \App\Filament\Widgets\Analytics\MemberStatusPieChartWidget::class,
            \App\Filament\Widgets\Analytics\FinancialSummaryPieChartWidget::class,
            \App\Filament\Widgets\Analytics\MemberTrendChartWidget::class,
            \App\Filament\Widgets\Analytics\MemberSourceChartWidget::class,
            \App\Filament\Widgets\Analytics\TopServicesChartWidget::class,
            \App\Filament\Widgets\Analytics\TopPlansChartWidget::class,
        ],
    ],
    ...
    */
    ...
    'custom_permissions' => \App\Support\Dashboard\DashboardAccess::customPermissions(),
    ...
    |--------------------------------------------------------------------------
    |
    | The role editor lives in the /system panel, but the operational resources
    | that need permissions live in the tenant /gym panel. Therefore discovery
    | must scan all Filament panels. RoleResource remains registered only in
    | /system via SystemPanelProvider; these options only affect permission
    | discovery/generation, not where RoleResource is mounted.
    |
    */
