                ...
                Fieldset::make('')
                    ...
                    ->schema([
                        TextEntry::make('enquiry.name')
                            ...
                            ->color('success')
                            ->url(fn ($record): string => \App\Filament\Resources\Enquiries\EnquiryResource::getUrl('view', ['record' => $record->enquiry_id])),
                        TextEntry::make('user.name')
                            ...
                            ->url(
                                fn ($record) => $record->user_id
                                    ? \App\Filament\Resources\Users\UserResource::getUrl('view', ['record' => $record->user_id])
                                    : null
                            ),
